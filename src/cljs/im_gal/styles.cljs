...
(def project-content-area (new-string "f-subheadline.fw6.bw2.dark-gray.h-75.bw2.w-100.flex.flex-column.bb"))
(def project-title (new-string "washed-green.ma1"))
(def project-about (new-string "fw3.f2.ma1"))
(def skills-content-area (new-string "f-subheadline.fw6.bw2.dark-gray.h-50.bw2.w-100.flex.flex-column.bb"))
