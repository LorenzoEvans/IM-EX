...
(def expr-bullet (new-string "f3.no-shadow.self-center.dark-gray.glow.bg-light-gray.br1.pa3.hover-dark-pink.ba.bw2.b--near-black.ma3.w-50"))
...
(def project-content-area (new-string "f-headline.fw6.dark-gray.vh-100.bw2.w-100.b--near-white.overflow-scroll.bl.b--washed-red"))
