...
(def project-content-area (new-string "f-headline.fw6.mb2.dark-gray.vh100.bw2.w-100.b--near-white.mt5.overflow-scroll.bl.b--washed-red.bw3.pl2"))
...
(def skills-content-area (new-string "f-subheadline.fw6.mb2.mt4.bw2.dark-gray.h-75.bw2.w-100.justify-between.bb"))
