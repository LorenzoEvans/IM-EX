...
(defn left-side []
  [:div.h-100.avenir.overflow-scroll.z-3.bw2.b--near-black.w-60.ml3-m
   ...
   [:section.mb2.tracked.threed-text.dark-gray.flex.flex-column.items-center.h-100.w-100.bt.bw2.b--near-white.mt4 {:class content-area} "Experience"]
   [:section.mb2.tracked.threed-text.dark-gray.flex.flex-column.items-center.h-100.bw2.w-100 {:class content-area} "Projects"]
   [:section.mb2.tracked.threed-text.dark-gray.flex.flex-column.items-center.h-25.w-100 {:class content-area} "Contact"]])